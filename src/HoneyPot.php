...
class HoneyPot implements ISecurityCheck
{
    ...
    * @return \Niirrty\Forms\Security\HoneyPot
    */
   ...
   /**
    * Builds the HTML text area or input form field honeypot that can be used inside you're form that should be protected.
    *
